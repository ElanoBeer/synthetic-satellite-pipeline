...
class VesselDetection:
    ...
    def perform_cross_validation(self, images_dir, labels_dir):
        ...
        kf = KFold(n_splits=self.n_folds, shuffle=True, random_state=1583891)
...
if __name__ == "__main__":
    # Parameters
    IMAGES_DIR = r"E:\Datasets\masati-thesis\synthetic_images\5_output_datasets\dataset5"  # Update with your image directory
    ANNOTATIONS_DIR = r"E:\Datasets\masati-thesis\synthetic_images\5_output_datasets\annotation5"  # Update with your annotations file
    OUTPUT_DIR = "E:/Datasets/masati-thesis/results/vessel_detection_output_5"
